...
namespace CazamioNewProject.DbHelpers.AspNetUsersTable
{
    public class AspNetUsersDbModels
    {
        ...
        public object? IsVisitsTutorialShown { get; set; }
        public object? LastResetPasswordDate { get; set; }
        public object? Cell { get; set; }
        public long MarketplaceId { get; set; }
        public object? LastSearchJson { get; set; }
        public object? LeadProfileComment { get; set; }
    }
}
