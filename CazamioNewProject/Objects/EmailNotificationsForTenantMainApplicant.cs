...
{
    public class EmailNotificationsForTenantMainApplicant
    {
        public SubjectsBasicInfo SubjectsBasic { get; set; }

        public static EmailNotificationsForTenantMainApplicant Generate()
        {
            return new EmailNotificationsForTenantMainApplicant
            {
