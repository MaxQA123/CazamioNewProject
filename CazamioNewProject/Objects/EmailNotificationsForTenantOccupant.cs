...
{
    public class EmailNotificationsForTenantOccupant
    {
        public SubjectsBasicInfo SubjectsBasic { get; set; }

        public static EmailNotificationsForTenantOccupant Generate()
        {
            return new EmailNotificationsForTenantOccupant
            {
