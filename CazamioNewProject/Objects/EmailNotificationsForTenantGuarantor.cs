...
{
    public class EmailNotificationsForTenantGuarantor
    {
        public SubjectsBasicInfo SubjectsBasic { get; set; }

        public static EmailNotificationsForTenantGuarantor Generate()
        {
            return new EmailNotificationsForTenantGuarantor
            {
