...
namespace CazamioNewProject.ApiHelpers.ApiObjects.MarketplaceAdminApiCollections.CreateBuildingApiMandatoryData
{
    public partial class BuildingCreationMandatoryData
    {
        ...
        public static RequestCreateBuildingMandatoryDataWithAgent RequestBodyCreateBuildingThirtyDashTrirtyNineCrownSt()
        {
            ...
            var payload = new RequestCreateBuildingMandatoryDataWithAgent
            {
                Address = new Address
                {
                    ...
                    Street = building.CrownSt.NumberNameAddressStatic,
                    State = building.CommonApiData.StateNy,
                    City = building.CommonApiData.CityBrooklyn,
                    ZipCode = building.CrownSt.Zip,
                    Neighborhood = building.CrownSt.Neighborhood
                },
        ...
        public static RestResponse CreateBuildingThirtyDashTrirtyNineCrownSt(string token, RequestCreateBuildingMandatoryDataWithAgent buildingRequestBody)
        {
