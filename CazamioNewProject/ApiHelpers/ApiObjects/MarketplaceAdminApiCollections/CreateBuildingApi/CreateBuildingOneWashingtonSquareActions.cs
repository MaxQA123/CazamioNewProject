...
namespace CazamioNewProject.ApiHelpers.ApiObjects.MarketplaceAdminApiCollections.CreateBuildingApiMandatoryData
{
    public partial class BuildingCreationMandatoryData
    {
        ...
        public static RequestCreateBuildingMandatoryDataWithAgent RequestBodyCreateBuildingOneWashingtonSquare()
        {
            ...
            var payload = new RequestCreateBuildingMandatoryDataWithAgent
            {
                Address = new Address
                {
                    ...
                    Street = building.WashingtonSquare.NumberNameAddressStatic,
                    State = building.CommonApiData.StateNy,
                    City = building.CommonApiData.CityNewYork,
                    ZipCode = building.WashingtonSquare.Zip,
                    Neighborhood = building.WashingtonSquare.Neighborhood
                },
        ...
        public static RestResponse CreateBuildingOneWashingtonSquare(string token, RequestCreateBuildingMandatoryDataWithAgent buildingRequestBody)
        {
