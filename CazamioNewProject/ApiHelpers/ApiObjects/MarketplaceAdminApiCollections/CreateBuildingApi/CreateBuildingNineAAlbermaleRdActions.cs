...
namespace CazamioNewProject.ApiHelpers.ApiObjects.MarketplaceAdminApiCollections.CreateBuildingApiMandatoryData
{
    public partial class BuildingCreationMandatoryData
    {
        ...
        public static RequestCreateBuildingMandatoryDataWithAgent RequestBodyCreateBuildingNineAAlbermaleRd()
        {
            ...
            var payload = new RequestCreateBuildingMandatoryDataWithAgent
            {
                Address = new Address
                {
                    ...
                    Street = building.AlbermaleRd.NumberNameAddressStatic,
                    State = building.CommonApiData.StateNy,
                    City = building.CommonApiData.CityBrooklyn,
                    ZipCode = building.AlbermaleRd.Zip,
                    Neighborhood = building.AlbermaleRd.Neighborhood
                },
        ...
        public static RestResponse CreateBuildingNineAAlbermaleRd(string token, RequestCreateBuildingMandatoryDataWithAgent buildingRequestBody)
        {
