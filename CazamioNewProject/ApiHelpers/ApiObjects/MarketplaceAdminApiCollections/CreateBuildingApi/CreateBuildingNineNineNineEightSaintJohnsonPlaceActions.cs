...
namespace CazamioNewProject.ApiHelpers.ApiObjects.MarketplaceAdminApiCollections.CreateBuildingApiMandatoryData
{
    public partial class BuildingCreationMandatoryData
    {
        ...
        public static RequestCreateBuildingMandatoryDataWithAgent RequestBodyCreateBuildingNineNineNineEightSaintJohnsonPlace()
        {
            ...
            var payload = new RequestCreateBuildingMandatoryDataWithAgent
            {
                Address = new Address
                {
                    ...
                    Street = building.SaintJohnsonPl.NumberNameAddressStatic,
                    State = building.CommonApiData.StateNy,
                    City = building.CommonApiData.CityBrooklyn,
                    ZipCode = building.SaintJohnsonPl.Zip,
                    Neighborhood = building.SaintJohnsonPl.Neighborhood
                },
        ...
        public static RestResponse CreateBuildingNineNineNineEightSaintJohnsonPlace(string token, RequestCreateBuildingMandatoryDataWithAgent buildingRequestBody)
        {
