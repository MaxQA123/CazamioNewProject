...
namespace CazamioNewProject.ApiHelpers.ApiObjects.MarketplaceAdminApiCollections.CreateBuildingApiMandatoryData
{
    public partial class BuildingCreationMandatoryData
    {
        ...
        public static RequestCreateBuildingMandatoryDataWithAgent RequestBodyCreateBuildingDeanStreet()
        {
        ...
        public static RestResponse CreateBuildingDeanStreet(string token, RequestCreateBuildingMandatoryDataWithAgent buildingRequestBody)
        {
