...
namespace CazamioNewProject.CreateApartmentMandatoryDataApi
{
    ...
    {
        public static RequestCreateApartmentMandatoryData RequestBodyCreateApartmentSignedLeaseStatus()
        {
            //111A East 51st Street Pedestrian Crossing
            // Get BuildingId from BD
            var buildingIdResult = BuildingsDbRequests.Buildings.GetBuildingIdEast51stStreetPedestrianCrossing();
        ...
        public static RestResponse CreateApartmentSignedLeaseStatus(string token, RequestCreateApartmentMandatoryData apartmentRequestBody)
        {
