...
namespace CazamioNewProject.CreateApartmentMandatoryDataApi
{
    ...
    {
        public static RequestCreateApartmentMandatoryData RequestBodyCreateApartmentVacantScndStatus()
        {
            //1 Washington square
        ...
        public static RestResponse RequestBodyCreateApartmentVacantScndStatus(string token, RequestCreateApartmentMandatoryData apartmentRequestBody)
        {
