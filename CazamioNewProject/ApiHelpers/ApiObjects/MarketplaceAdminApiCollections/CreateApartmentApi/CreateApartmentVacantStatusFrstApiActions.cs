...
namespace CazamioNewProject.CreateApartmentMandatoryDataApi
{
    ...
    {
        public static RequestCreateApartmentMandatoryData RequestBodyCreateApartmentVacantFrstStatus()
        {
            //1 Washington square
        ...
        public static RestResponse RequestBodyCreateApartmentVacantFrstStatus(string token, RequestCreateApartmentMandatoryData apartmentRequestBody)
        {
